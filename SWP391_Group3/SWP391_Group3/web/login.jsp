...
<html lang="zxx" class="no-js">
    ...
    <body>
                                        ...
                                        <label>
                                            <div class="input-group-prepend">
                                                <div style="display: flex;">
                                                    ...
                                                    <button type="button" class="btn btn-light" style="width: 50px; background-color: white;" onclick="refreshCaptcha()">
                                                        <i class="fa fa-refresh" style="color: black;"></i>
                                                    </button>
                                                </div>
                                                <input id="captcha" type="text" name="captchaResponse" />
                                            </div>
                                        </label>
                                    </div>
                                    <div class="col-md-12 form-group">
        ...
        <script>
            ...
            {
                // S? d?ng AJAX ?? làm m?i ?nh CAPTCHA
                $.get('refreshcaptcha', function () {
                    // Thay ??i src c?a ?nh ?? làm m?i
