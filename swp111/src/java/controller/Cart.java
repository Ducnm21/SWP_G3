...
public class Cart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < list.size(); i++) {
            sum += list.get(i).getPrice() + list.get(i).getTransactionfees();
        }
        request.setAttribute("userId", u.getId());
        request.setAttribute("totalfee", String.format("%,.0f", sum) + " ₫");
...
//        BodyDAO d = new BodyDAO();
//
//        List<CartXOrder> list = d.getAllCart(19);
//        for (CartXOrder cartXOrder : list) {
//            System.out.println(cartXOrder);
//        }
//    }
