 ...
 * @author VIVO-S15
 */
public class loadorderbyreceivedanduserid extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            switch (received) {
                case "0-250000":
                    printOrderTable(out, dao.get0To250kReceivedByUser_ID(uid));
                    break;
                case "250000-500000":
                    printOrderTable(out, dao.get250kTo500kReceivedByUser_ID(uid));
                    break;
                case "500000-1000000":
                    printOrderTable(out, dao.get500kTo1mReceivedByUser_ID(uid));
                    break;
                case "1000000-5000000":
                    printOrderTable(out, dao.get1mTo5mReceivedByUser_ID(uid));
                    break;
                case "5000000+":
                    printOrderTable(out, dao.getOver5mReceivedByUser_ID(uid));
                    break;
                default:
