 ...
 * @author VIVO-S15
 */
public class searchbycontact extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String txtSearchC = request.getParameter("txtcontact");
        ProductDAO dao = new ProductDAO();
        List<Product> list = dao.searchByContactWithUser_ID(txtSearchC, uid);
        ...
        out.println("   </tbody>\n"
                + "</table>");
        request.setAttribute("sncontact", txtSearchC);
    } 
