 ...
 * @author VIVO-S15
 */
public class loadpublicprivateproductanduserid extends HttpServlet {
        ...
        try ( PrintWriter out = response.getWriter()) {
            switch (publicprivate){
                case "...":
                    break;
                case "Public":
                    printOrderTable(out, dao.getPublicOrderByUser_ID(uid));
                    break;
                case "Private":
                    printOrderTable(out, dao.getPrivateOrderByUser_ID(uid));
                    break;
                default:
                    out.println("Invalid");
                    break;
