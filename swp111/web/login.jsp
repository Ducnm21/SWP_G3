            ...
            <div class="main_menu">
                <nav class="navbar navbar-expand-lg navbar-light main_box">
                    <div class="container">
                        ...
                        <a class="navbar-brand logo_h" href="login.jsp"><img src="img/logosclc.png" alt=""></a>
                                    ...
                                    <label> 
                                        <div class="input-group-prepend">
                                            <div style="display: flex;">
                                                ...
                                                <img id="captchaImage" src="captchaGenerate" alt="CAPTCHA image" />
                                                <button id="refreshButton" type="button" class="btn btn-light" style="width: 50px; background-color: white;" onclick="refreshCaptcha()">
                                                    <i class="fa fa-refresh" style="color: black;"></i>
                                                </button>
                                            </div>
                                            <input id="captcha" type="text" placeholder="Enter captcha here" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter captcha here'"/>
                                        </div>                                  
                                    </label>
                                </div>
                                <div class="col-md-12 form-group">
